...
from main_service.main_service_functions import get_results, delete_results
...
def main_services():
    ...
    if request.method == "POST":
        data = request.json
        return Response(response=json.dumps(data, indent=4), status=201, mimetype="application/json")
